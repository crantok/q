...
*/
function cti_flex_menu_item($link, $has_children, $menu = '', $in_active_trail = FALSE, $extra_class = NULL) {
  ...
  $class .= ' ' . preg_replace("/[^a-zA-Z]/", "", strip_tags($link));

  $result = '<li class="'. $class .'" id="' . $id . '">'. $link . $menu ."</li>\n";
  //dsm( $link );
  return $result;
}
